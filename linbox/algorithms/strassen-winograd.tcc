/* linbox/algorithms/strassen-winograd.h
...
#ifndef __LINBOX_ALGORITHMS_STRASSEN_WINOGRAD_TCC
#define __LINBOX_ALGORITHMS_STRASSEN_WINOGRAD_TCC
...
Matrix3 &StrassenWinograd::gemm_res (const Ring &R, Modules &M, const typename Ring::Element &a, const Matrix1 &A, const Matrix2 &B, const typename Ring::Element &b, Matrix3 &C,
...
template <class Ring, class Modules, class Matrix1, class Matrix2, class Matrix3>
Matrix3 &StrassenWinograd::mul (const Ring &R, Modules &M, const typename Ring::Element &a, const Matrix1 &A, const Matrix2 &B, Matrix3 &C)
{
...
template <class Ring, class Modules, class Matrix1, class Matrix2, class Matrix3>
Matrix3 &StrassenWinograd::addmul (const Ring &R, Modules &M, const typename Ring::Element &a, const Matrix1 &A, const Matrix2 &B, const typename Ring::Element &b, Matrix3 &C)
{
	linbox_check (A.coldim () == B.rowdim ());
	linbox_check (A.rowdim () == C.rowdim ());
	linbox_check (B.coldim () == C.coldim ());
...
template <class Ring, class Modules, class Matrix1, class Matrix2, class Matrix3>
Matrix3 &StrassenWinograd::mul_ip (const Ring &R, Modules &M, const typename Ring::Element &a, const Matrix1 &A, const Matrix2 &B, Matrix3 &C)
{
	return C;
}

template <class Ring, class Modules, class Matrix1, class Matrix2, class Matrix3>
Matrix3 &StrassenWinograd::addmul_ip (const Ring &R, Modules &M, const typename Ring::Element &a, const Matrix1 &A, const Matrix2 &B, const typename Ring::Element &b, Matrix3 &C)
{
	return C;
}

template <class Ring, class Modules, class Matrix1, class Matrix2, class Matrix3>
Matrix3 &StrassenWinograd::mul_ow (const Ring &R, Modules &M, const typename Ring::Element &a, Matrix1 &A, Matrix2 &B, Matrix3 &C)
{
	return C;
}

template <class Ring, class Modules, class Matrix1, class Matrix2, class Matrix3>
Matrix3 &StrassenWinograd::addmul_ow (const Ring &R, Modules &M, const typename Ring::Element &a, Matrix1 &A, Matrix2 &B, const typename Ring::Element &b, Matrix3 &C)
{
	return C;
}
...
#endif // __LINBOX_ALGORITHMS_STRASSEN_WINOGRAD_TCC
