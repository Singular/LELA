...
#ifndef __LINBOX_ALGORITHMS_STRASSEN_WINOGRAD_H
#define __LINBOX_ALGORITHMS_STRASSEN_WINOGRAD_H
...
#include "linbox/algorithms/strassen-winograd.tcc"

#endif // __LINBOX_ALGORITHMS_STRASSEN_WINOGRAD_H
