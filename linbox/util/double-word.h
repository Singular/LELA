 ...
 * linbox/integer.h depends on it to provide a 128-bit data-type when
 * one is not provided by the system.
 */

#ifndef __LINBOX_DOUBLE_WORD_H
#define __LINBOX_DOUBLE_WORD_H
