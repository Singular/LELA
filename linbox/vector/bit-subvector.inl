...
namespace std 
{
	...
	struct iterator_traits<LinBox::BitSubvectorWordIterator<Iterator, ConstIterator> >
	{
		...
		typedef typename LinBox::BitVector::word_iterator::value_type value_type;
		typedef typename LinBox::BitVector::word_iterator::difference_type difference_type;
	};
	...
	{
		typedef random_access_iterator_tag iterator_category;
		typedef typename LinBox::BitVector::const_word_iterator::value_type &reference;
		typedef typename LinBox::BitVector::const_word_iterator::value_type *pointer;
		typedef typename LinBox::BitVector::const_word_iterator::value_type value_type;
		typedef typename LinBox::BitVector::const_word_iterator::difference_type difference_type;
	};
}
